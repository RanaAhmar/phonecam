...
This guide explains how to use **Droid Camera** as a video source in OBS Studio.
...
- Droid Camera Mac app running
- Android phone connected (USB or WiFi)
- Virtual camera started in Droid Camera

---

## Step 1: Start the Virtual Camera

1. Open **Droid Camera** from the menu bar (camera icon)
2. Click **"Open Droid Camera…"**
3. Connect your phone (USB or WiFi)
4. Click **"Start Virtual Camera"**
5. The button changes to **"Stop Virtual Camera"** — the camera is now active
...
5. In the **Device** dropdown, select **"Droid Camera"**
6. Click **OK**
...
- **Encoder**: Hardware (NVENC/AMF/VideoToolbox) — offloads CPU
...
### "Droid Camera" doesn't appear in OBS
1. Make sure the virtual camera is **started** in the Droid Camera app
...
- **USB mode** is recommended for OBS — connect via USB cable
- Ensure USB cable supports data transfer (not charge-only)
- Close other apps on your Mac to free up CPU for OBS

### Camera appears rotated
- Use OBS's built-in **Transform** → **Rotate** to correct orientation
- Or use the rotation controls in the Droid Camera Mac app

---

## Tips for Content Creators

- **USB connection** gives the lowest latency — ideal for live streaming
- Use **1080p/60fps** for the best quality in OBS
- The virtual camera supports OBS's built-in **filters and effects**
- Compatible with **OBS Virtual Camera** output (you can chain them)
- Works with **NDI Tools** if you have the NDI OBS plugin installed
